...
class StaticContractTests(unittest.TestCase):
    ...
    def test_elasticsearch_standalone_and_cluster_deployment_contract(self):
        ...
        self.assertIn("custom_elasticsearch_yml", schemas)
        ...
        self.assertIn('"custom_elasticsearch_yml": instance.get("custom_elasticsearch_yml") or ""', worker)
        ...
        self.assertIn("importElasticsearchConfig", frontend)
        self.assertIn("FileReader", frontend)
        self.assertIn("导入 elasticsearch.yml", frontend)
        self.assertIn("custom_elasticsearch_yml: item.custom_elasticsearch_yml || null", frontend)
        ...
        self.assertIn("Write platform Elasticsearch configuration", role_tasks)
        self.assertIn("custom_elasticsearch_yml | default('', true) | length == 0", role_tasks)
        self.assertIn("Write user-provided Elasticsearch configuration with highest priority", role_tasks)
        self.assertIn("custom_elasticsearch_yml | default('', true) | length > 0", role_tasks)
